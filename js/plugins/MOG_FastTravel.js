...
//=============================================================================	
	...
	Moghunter.fastTravel_Towns[5] = {name:"城镇-春季",x:1885,y:568,mapID:4,mapX:22,mapY:8,direction:2};
	Moghunter.fastTravel_Towns[6] = {name:"城镇-夏季",x:940,y:1410,mapID:10,mapX:27,mapY:8,direction:2};
	Moghunter.fastTravel_Towns[7] = {name:"城镇-秋季",x:1980,y:1520,mapID:12,mapX:26,mapY:12,direction:2};
	Moghunter.fastTravel_Towns[8] = {name:"城镇-冬季",x:634,y:612,mapID:11,mapX:27,mapY:12,direction:2};
